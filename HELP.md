...
* The original package name 'af.ex.kube.kube-operator' is invalid and this project uses 'af.ex.kube.kubeoperator' instead.
...
```
$ docker run --rm kube-operator:0.0.1-SNAPSHOT
```
